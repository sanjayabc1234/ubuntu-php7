...
LABEL Description = "Based on Ubuntu 16.04 LTS. It includes LAMP stack tailored for new dc. Usage='docker run -p [HOST WWW PORT NUMBER]:80 -v [HOST WWW DOCUMENT ROOT]:/var/www/html ubuntu:16.04 bash'"
